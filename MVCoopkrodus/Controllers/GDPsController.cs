...
namespace MVCoopkrodus.Controllers
{
    public class GDPsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Country,Region,EstimatebyDollar,Population")] GDP gDP)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Country,Region,EstimatebyDollar,Population")] GDP gDP)
        {
            if (id != gDP.Id)
            {
                return NotFound();
